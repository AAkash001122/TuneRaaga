...
const Dashboard = () => {
  ...
  // ─── AUDIO STATE ───
  const audioRef = useRef(null); // Initialize inside useEffect
    ...
    <div className="relative bg-white">
          ...
          >
            ...
            <div className="mt-4 mb-2">
              <img
                ...
                className="w-[280px] md:w-[400px] h-auto object-contain drop-shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
              />
            </div>
      ...
      <div className="relative z-10 -mt-32 pb-20 space-y-8">
        {allRows.map((row, idx) => {
          if (row.isLoading) {
             return (
               <div key={idx} className="relative group/row px-8 md:px-16">
